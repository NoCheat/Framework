...
/**
 * Name is to be CamelCase. Permissions will be lower case constructed of name. Full name is joined by dots.
 * 
 * Usage:
 * <li>Store data with this as key.</li>
 * <li>Model check hierarchies.</li>
 * <li>Quick access to permission.</li>
 * <li>Used for commands and notifications to identify a check.</li>
 * 
 * @author mc_dev
 *
 */
