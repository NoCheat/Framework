...
public class MiniListenerNode<E, P>{
	...
	/**
	 * This is intended to be "complete" in terms of containing all information for order, extra properties like ignoreCancelled.
	 * @author mc_dev
	 *
	 * @param <E>
	 */
	...
	/**
	 * Add a ListenerEntry to the internals (final stage, should be fully implemented in the abstract node).
	 * @param entry
	 */
